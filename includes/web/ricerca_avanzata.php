...
<form action="./index.php?page=risultati_ricerca" method="get">
    <div class="input_field" style="margin-top: 10px;">
    <div class="frame">
        <div class="frame_header">
            <p>Includi i seguenti campi</p>
            <select name="option" class="input_select">
        ...
        <div class="row input">
            <select name="target_1" class="input_select">
            ...
            <input type="text" name="box_1" value="" class="input_group_form" style="float: none;">
        </div>
        <div class="row">
            <select name="target_2" class="input_select">
            ...
            <input type="text" name="box_2" value="" class="input_group_form" style="float: none;">
        </div>
        <div class="row">
            <select name="target_3" class="input_select">
                <option value="autore">Autore</option>
                <option value="titolo">Titolo</option>
            ...
            <input type="text" name="box_3" value="" class="input_group_form" style="float: none;">
        </div>
    </div>
</div>
<div>
    <button type="submit" name="page" value="risultati_ricerca" class="btn btn_submit" style="margin-top: 5px;">Cerca</button>
</div>
    <div>
