<div>
    <h1 class=page_header>netiquette</h1>
    <p>
        Fra gli utenti dei servizi telematici di rete, prima fra tutte la rete Internet,  si sono sviluppati nel corso del tempo una serie di "<b>tradizioni</b>" e di "<b>principi di buon comportamento</b>" (galateo) che vanno collettivamente sotto il nome di "<b>netiquette</b>". Tenendo ben a mente che la entita' che fornisce l'accesso ai servizi di rete (provider, istituzione pubblica, datore di lavoro, etc.) puo' regolamentare in modo ancora piu' preciso i doveri dei propri utente, riportiamo in questo documento un breve sunto dei principi fondamentali della "netiquette", a cui tutti sono tenuti ad adeguarsi.
    </p>
    <ol>
        <li>
            <b>
    ...
    <br>
    <p>
        (questa Netiquette si trova su <a href=http://www.nic.it/tutto-sul.it/netiquette>Registro.it</a>)
    </p>
</div>